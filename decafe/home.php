...
<div class="col-lg-9 mt-2">
  ...
  <div class="card mt-4 border-0 bg-light">
    <div class="card-body text-center">
      ...
      <p class="card-text">Aplikasi pemesanan makanan dan minuman yang mudah dan praktis. Nikmati beragam makanan
        dan minuman
        favorit anda dengan beberapa klik. Pesan, bayar dan lacak pesanan Anda dengan mudah melalui aplikasi
        ini.</p>
